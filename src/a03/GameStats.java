...
public class GameStats implements Serializable{
	...
	//Note about this class terrible designed. each statistics should be in its own individual GameStatsData object the current method is not scalable.
	//implementing Serializable and generating a serialVersionUID means that the binary file generated by this object cannot be edited.
...
//-------------------------------------- End of Getters -------------------------------------
	...
	/**
	 * This method is called once the game transitions to the ScoreScene which signifies that the level has been completed and hence the statistics should be updated.
	 * 
	 * @param difficulty - the difficulty of the current level, used to update the correct corresponding difficulties statistics.
	 * @param level - the level of the current level, used to update the correct corresponding difficulties statistics.
	 * @param correctAnswers - the number of correct answers to be updated.
	 */
	...
	/**
	 * Getter method for the singleton object of this class.
	 * @return GameStats object that represents the GameStats singleton.
	 */
